...
import {fetchingNowPlaying} from "../../Reducers/ActionCreators";
...
const NowPlaying = () => {
    ...
    useEffect(() => {
        dispatch(fetchingNowPlaying(currentPage, language))
    ...
    return (
        <div className="w-full h-full fixed left-0 top-0 z-10"
            ...
            <div className='pt-[40px]'>
                <h1 className='text-center text-3xl mb-[50px]'>Now PLaying Movies</h1>
